...
RazorBackRoar takes security seriously. This policy applies to **RazorBackRoar** and matches the organization-wide standard used across RazorBackRoar product repositories.
...
2. **Maintainer contact** — send an email to the address listed on the [@RazorBackRoar](https://github.com/RazorBackRoar) GitHub profile with a clear subject such as `SECURITY: RazorBackRoar`.
...
Please use [GitHub Issues](https://github.com/RazorBackRoar/RazorBackRoar/issues) for ordinary bugs and feature requests.
