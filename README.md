...
[![RyuSync](https://img.shields.io/badge/RyuSync-v5.0.0-blue?style=for-the-badge&logo=apple)](https://github.com/RazorBackRoar/RyuSync/releases)
[![Rusty](https://img.shields.io/badge/Rusty-v4.0.0-orange?style=for-the-badge&logo=apple)](https://github.com/RazorBackRoar/Rusty/releases)
...
| [**RyuSync**](https://github.com/RazorBackRoar/RyuSync) | Nintendo Switch `.nsp` / `.xci` file organizer with Dry Mode preview | Python · PySide6 | [v5.0.0](https://github.com/RazorBackRoar/RyuSync/releases) |
| [**Rusty**](https://github.com/RazorBackRoar/Rusty) | Exact duplicate photo & video finder with BLAKE3 hashing and quarantine | Rust · Tauri 2 | [v4.0.0](https://github.com/RazorBackRoar/Rusty/releases) |
